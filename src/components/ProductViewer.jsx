        ...
        <div className="controls">
            ...
            <div className="flex-center gap-4 mt-4">
                <div className="color-control">
                    <div onClick={() => setColor('#c8cdd3')} className={clsx('bg-neutral-300', color === "#c8cdd3" && 'active')}></div>
                    <div onClick={() => setColor('#48464a')} className={clsx('bg-neutral-700', color === "#48464a" && 'active')}></div>
                </div>
